...
if(isset($submit)){
    ...
    if(empty($kodeklausal) or empty($kodekeamanan) or empty($kodetujuan) or empty($kuisioner) or empty($jawaban)){
        ...
        $ins = mysqli_query($con,"insert into t_kuisioner(kode_klausal,kode_keamanan,kode_tujuan,kuisioner,jawaban,created_at) 
                                                        values ('$kodeklausal','$kodekeamanan','$kodetujuan','$kuisioner','$jawaban','$tgl')");
